...
$upload_dir = '/tconnectchurch/upload/images/'; // path from base_url to base of upload folder (with start and final /)
$current_path = $_SERVER['DOCUMENT_ROOT'].'/tconnectchurch/upload/images/'; // relative path from filemanager folder to upload folder (with final /)
