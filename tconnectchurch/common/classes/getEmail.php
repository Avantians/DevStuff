...
// Build the list of image extensions
      ...
      if ( _getCheckNullorNot( $html_images ) ){
 ...
 *  ------------------------------------------------------------------------- */
    function add_text( $text = '' ){
      $this->text = _getConvertLinefeeds( array( "\r\n", "\n", "\r" ), $this->lf, $text );
    }
 ...
 *  ------------------------------------------------------------------------- */
    function add_html( $html, $text = NULL, $images_dir = NULL ){
      $this->html = _getConvertLinefeeds( array( "\r\n", "\n", "\r" ), '<br />', $html );
      $this->html_text = _getConvertLinefeeds( array( "\r\n", "\n", "\r" ), $this->lf, $text );
...
//    function &add_text_part( &$obj, $text ){
    function add_text_part( &$obj, $text ){
      ...
      if ( is_object( $obj ) ){
        ...
        return new getMime( $text, $params );
      }
    }
...
//    function &add_html_part( &$obj ){
    function add_html_part( &$obj ){
      ...
      if ( is_object( $obj ) ){
        ...
        return new getMime( $this->html, $params );
      }
    }
...
//    function build_message( $params = array() ){
    function build_message( $params = '' ){
      ...
      if ( _getCheckNullorNot( $this->html_images ) ){
      ...
      $null = NULL;
      $attachments = ( ( _getCheckNullorNot( $this->attachments ) ) ? true : false );
      $html_images = ( ( _getCheckNullorNot( $this->html_images ) ) ? true : false );
      $html = ( ( _getCheckNullorNot( $this->html ) ) ? true : false );
      $text = ( ( _getCheckNullorNot( $this->text ) ) ? true : false );
...
//          $message =& $this->add_mixed_part();
        ...
        case ( ( $html == true ) && ( $attachments == false ) && ( $html_images == false ) ):
          if ( _getCheckNullorNot( $this->html_text ) ){
/* HPDL PHP3 */
