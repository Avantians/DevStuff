...
*
*/
class getContentType extends getHeader
{
    // Get contents header
    public function __construct( $file = null, $extension ){
        getHeader::setHeader( $file, $extension );
    }

    // Get contetns type
    public function contentType( $fileExtension )
    {
